...
![Figure 1. Posterior-mean trajectory of the calibrated filter from a 100x-wrong prior toward the truth, three independent random seeds.](plots/fig1_prior_migration.png)
...
![Figure 2. Mean-squared error versus shots for three methods, minimum-maximum spread across three seeds shaded. Sliding-window MLE wins across every tested operating point.](plots/fig2_mse_vs_T.png)
...
![Figure 3. Log-likelihood gap between truth and 100x-wrong particles versus batch size on a fixed small fixture. The pair-correlation gap flips sign at batch sizes above 100, revealing how fragile single-fixture per-shot informativeness comparisons are.](plots/fig3_log_L_gap_vs_batch.png)
